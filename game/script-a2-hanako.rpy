...
show hanako emb_timid_close onlayer master at tworight
with charamove
...
show hanako emb_emb_close onlayer master
with charachange
...
show hanako emb_blushtimid_close onlayer master
with charachange
...
show hanako defarms_shock_close onlayer master
with Dissolve(0.2)
...
show hanako emb_smile onlayer master at Transform(xanchor=0.5, xpos=0.58)
show lilly basic_smileclosed onlayer master at Transform(xanchor=0.5, xpos=0.42)
with charaenter
...
show hanako emb_downtimid_ss onlayer master at Transform(xanchor=0.5, xpos=0.58)
show lilly basic_smile_ss onlayer master at Transform(xanchor=0.5, xpos=0.42)
with charaenter
...
show lilly basic_weaksmile_ss onlayer master
with charachange
...
show hanako emb_emb_ss onlayer master at Transform(xanchor=0.5, xpos=0.58)
show lilly basic_smileclosed_ss onlayer master at Transform(xanchor=0.5, xpos=0.42)
with charaenter
...
scene bg suburb_shanghaiext_ss onlayer master
with locationskip
...
"It looks like the type of place you'd walk by without a thought, just another generic caf� in a sea of thousands."
...
scene bg suburb_shanghaiint onlayer master at Fullpan(5.0, dir="right")
with locationchange
...
show yuukoshang noglasses_up onlayer master at Transform(ypos=1.25)
...
show yuukoshang noglasses_up onlayer master at center
with charamove
...
show yuukoshang noglasses_up onlayer master at tworight
...
"Yuuko hurries off to the back of the cafe, leaving us still standing at the entrance."
...
show hanako defarms_shock onlayer master at Transform(xpos=0.8)
show lilly basic_surprised onlayer master at Transform(xpos=0.2)
...
show yuukoshang worried_up onlayer master at centertremble
with charachange
...
show yuukoshang worried_up onlayer master at Transform(ypos=1.1)
with ease
...
show yuukoshang neutral_down onlayer master at Transform(ypos=1.2)
with Dissolvemove(0.2)
...
show yuukoshang neurotic_up onlayer master at Transform(ypos=1.17)
with charamove
...
hide fireshine onlayer master
show bg misc_sky_ni as front onlayer master
...
show hanako_fw behind bg onlayer master:
    truecenter zoom 1.05 subpixel True
    ease 22.0 zoom 1.0
show ev hanako_shanghaiwindow behind hanako_fw onlayer master:
    truecenter zoom 1.05 subpixel True
    ease 22.0 zoom 1.0
with None
...
show yuukoshang panic_up onlayer master at center
with Dissolvemove(0.2)
...
show yuukoshang smile_down onlayer master at Transform(ypos=1.17)
with charamove
...
scene bg suburb_shanghaiext_ni onlayer master
with locationchange
...
show hanako emb_timid_ni onlayer master at Transform(xanchor=0.5, xpos=0.59)
show lilly basic_weaksmile_ni onlayer master at Transform(xanchor=0.5, xpos=0.41)
with charaenter
...
show lilly basic_cheerful_ni onlayer master
with charachange
...
menu:
    ...
    "What do you think, Hanako?" if True:


        return m1
    "I've done enough work for the council already." if True:
...
scene ev lilly_bedroom_large onlayer master:
    xpos -234 ypos -720 subpixel True
    acdc_warp 4.0 ypos -1080
with flash
...
show ev lilly_bedroom_large onlayer master:
    ease 1.0 ypos -540 xpos -1494
    acdc_warp 12.0 ypos 0 xpos -1494
with None
