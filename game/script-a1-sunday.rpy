...
show kenji neutral onlayer master at Slide(0.0,0.3,0.0,0.2,0.5)
with Dissolve(.5)
...
scene bg school_dormhallway onlayer master
show shizu behind_blank_close onlayer master at center
with locationchange
...
show shizu behind_frustrated_close onlayer master at Slide(0.5,0.5,0.7,0.5,1.0, time_warp=_ease_time_warp)
with None

show misha hips_grin behind shizu onlayer master at Slide(0.5,0.5,0.3,0.5,1.0)
show shizu behind_frustrated_close onlayer master at Slide(0.5,0.5,0.7,0.5,1.0,time_warp=_ease_time_warp)
with Dissolve(0.7)
...
show shizu basic_angry_close onlayer master at tworight
with charachange
...
show misha hips_smile_close onlayer master at closeleft
with characlose
...
show shizu basic_normal2_close behind misha onlayer master at tworight
with None
...
show shizu basic_normal2 onlayer master at tworight
...
scene bg school_stalls1 onlayer master
with locationchange
...
show misha hips_smile onlayer master at Slide(0.2,0.5,0.3,0.5,1.0)
show shizu behind_blank onlayer master at Slide(0.8,0.5,0.7,0.5,1.0)
with Dissolve(1.0)
...
scene bg school_stalls1_ss onlayer master
with shorttimeskip
...
show shizu behind_smile_close_ss onlayer master at center
with charaenter
...
show bg school_stalls1_ss onlayer master at bgright
show shizu behind_smile_close_ss onlayer master at closeright
with charamove

show misha cross_laugh_ss onlayer master at twoleft
with charaenter
...
show shizu adjust_happy_close_ss onlayer master
with charachange

shi "..."

show misha cross_grin_ss onlayer master
with charachange

mi "No, but it doesn't matter, it doesn't matter~! Come on, Hicchan, before it gets too crowded!"

show misha hips_grin_close_ss onlayer master at closeleft
with characlose
...
show shizu cross_wut_close_ss onlayer master
with charachange
...
show misha cross_laugh_close_ss onlayer master
with charachange

mi "Hahahahaha!"

show misha cross_smile_close_ss onlayer master
with charachange

hi "I like to savor everything that I eat. Even this."

show shizu basic_sparkle_close_ss onlayer master
with charachange

show shizu adjust_smug_close_ss onlayer master
with charachange
...
show misha cross_laugh_close_ss onlayer master
show shizu behind_smile_close_ss onlayer master
with charachange
...
show shizu behind_smile_ss onlayer master at tworight
show misha hips_smile_ss onlayer master at twoleft
with charaenter
...
show misha cross_laugh_ss onlayer master
with charachange
...
show misha perky_smile_ss onlayer master
with charachange
...
scene bg school_stalls2_ss onlayer master at bgright
with locationchange

"Fortunately, the two of them fail to catch a single fish, but I don't do any better."

show bg school_stalls2_ss onlayer master at bgleft
with charamove
...
show shizu behind_smile_ss onlayer master at Slide(0.8,0.5,0.7,0.5,1.0)
show misha perky_smile_ss onlayer master at Slide(0.2,0.5,0.3,0.5,1.0)
with Dissolve(1.0)

shi "..."

show misha hips_grin_ss onlayer master at twoleft
with charachange
...
show misha hips_frown_ss onlayer master
with charachange

mi "And me!"

show shizu basic_angry_ss onlayer master at tworight
with charachange
...
show misha sign_smile_ss onlayer master
with charachange
...
show stuffedcat onlayer master:
...
hide stuffedcat onlayer master
with None
...
show misha cross_smile_ss onlayer master
with charachange
...
show shizu behind_smile_ss onlayer master at Slide(0.7,0.5,0.8,0.5,1.0, time_warp=_ease_out_time_warp)
show misha perky_smile_ss onlayer master at Slide(0.3,0.5,0.2,0.5,1.0, time_warp=_ease_out_time_warp)
with None
...
show shizu adjust_blush_close_ss onlayer master at Slide(0.8,0.5,0.7,0.5,0.5)
show misha perky_confused_close_ss onlayer master at Slide(0.2,0.5,0.3,0.5,0.5)
with Dissolve(0.5)
...
show misha hips_frown_close_ss onlayer master at twoleft
with charachange
...
show shizu basic_normal2_close_ss onlayer master at tworight
with charachange
...
show shizu behind_smile_ni onlayer master at tworight
show misha perky_smile_ni onlayer master at twoleft
with charaenter
...
show misha hips_smile_ni onlayer master
with charachange
...
show shizu adjust_happy_ni onlayer master
with charachange

shi "..."

show misha hips_grin_ni onlayer master
with charachange

mi "Ah! How about sandwiches, then? And we'll need something to drink, too! Misha'll get everything!"

show misha perky_confused_ni onlayer master
with charachange
...
show shizu adjust_happy_ni onlayer master at Slide(0.7,0.5,0.5,0.5,0.5,time_warp=_ease_time_warp)
with None

show shizu cross_angry_close_ni onlayer master at Slide(0.7,0.5,0.5,0.5,0.5,time_warp=_ease_time_warp)
with Dissolve(0.5)
...
scene bg school_roof_ni onlayer master
with locationskip
...
show shizu behind_smile_close_ni onlayer master at center
with charaenter
...
show shizu behind_smile_close_ni onlayer master at tworight
show bg school_roof_ni onlayer master at bgright
with charamove

show misha hips_grin_ni behind shizu onlayer master at twoleft
with charaenter
...
scene black onlayer master
show bg misc_sky_ni onlayer master at Fullpan(30.0)
with locationchange
...
show shizu behind_frustrated_close_ni onlayer master at center
show bg misc_sky_ni onlayer master at right
with charaenter
...
show shizu out_serious_close_ni onlayer master
with charachange
...
show shizu epictransition onlayer master
show cityscape zoom behind shizu onlayer master
show hill enter behind shizu onlayer master
...
hide shizu onlayer master
show hill pairtouch onlayer master at center
with charachange
...
show fireworks behind hill onlayer master
with None
show fw_screen behind fireworks onlayer master
with Dissolve(5.0)
...
hide fireworks onlayer master
hide fw_screen onlayer master
show hill pairnotouch onlayer master
with Dissolve(5.0)
...
show emi basic_annoyed onlayer master at Slide(0.7,0.5,0.5,0.5,0.5)
with charaenter
...
show emi sad_shy_close onlayer master at center
with charaenter
...
scene bg school_dormext_full onlayer master at bgright
with locationchange
...
show emi basic_hes onlayer master at Slide(0.4,0.5,0.5,0.5,0.5)
with charaenter

emi "You're not going to die on me, are you?"

show emi basic_shock onlayer master at center
with charachange
...
show rin basic_absent onlayer master at Slide(1.0,0.5,1.0,1.0,1.0)
with Dissolve(1.0)
...
show bg school_dormext_full onlayer master at center
with charamove
...
scene bg mural onlayer master at Fullpan(100.0, dir="left")
with Dissolve(2.0)
...
scene bg school_stalls1 onlayer master at Fullpan(8.0)
with locationskip
...
show rin relaxed_boredom onlayer master at tworight
with Dissolve(2.0)
...
scene bg mural onlayer master at Transform(xalign=0.05)
with Dissolve(2.0)
...
show bg mural onlayer master at Transform(xalign=0.25)
with charamove
...
show bg mural onlayer master at Transform(xalign=0.45)
with charamove
...
show bg mural onlayer master at Slide(0.45,0.45,.6,0.6,25.0, time_warp=acdc_warp)
with None
...
show rin negative_spaciness_close onlayer master at offscreenright
with None

show rin negative_spaciness_close onlayer master at tworight
show bg mural onlayer master at Transform(xalign=0.6)
...
show rin basic_deadpannormal_close onlayer master at tworight
with Dissolve(1.5)
...
scene mural all onlayer master
with flash
...
scene bg mural onlayer master at Slide(1.0,1.0,0.6,0.6,40.0, time_warp=acdc_warp)
with flash
...
scene bg mural onlayer master at Transform(xalign=0.6)
show rin negative_spaciness_close onlayer master at tworight
with flash
...
scene bg mural onlayer master at Transform(xalign=0.6)
show rin negative_annoyed_close onlayer master at tworight
with locationchange
...
show rin negative_confused onlayer master at tworight
with charachange
...
show rin basic_deadpannormal_close onlayer master at Slide(0.8,0.5,0.7,0.5,1.0)
with Dissolve(1.0)
...
scene bg mural_ss onlayer master at Transform(xalign=0.6)
show rin basic_deadpannormal_close_ss onlayer master at tworight
show rin_shadow basic behind rin onlayer master:
...
show rin basic_deadpansurprised_close_ss onlayer master
with charachange
...
show rin_shadow negative onlayer master at Transform(xpos=0.8,ypos=1.0,xanchor=0.5,yanchor=0.9)
with charachange
...
scene bg mural_ss onlayer master at Transform(xalign=0.6)
show rin basic_deadpannormal_close_ss onlayer master at tworight
show rin_shadow basic behind rin onlayer master at Transform(xpos=0.8,ypos=1.0,xanchor=0.5,yanchor=0.9)
with openeye
...
show rin basic_deadpanupset_close_ni onlayer master at Transform(xpos=0.9, xanchor=0.5, ypos=1.1)
with charachange
...
show rin basic_deadpan_close_ni onlayer master
with charachange
...
show rin relaxed_sleepy_close_ni onlayer master
with charachange

rin "I fell asleep."

show rin basic_awayabsent_close_ni onlayer master
with charachange
...
show rin negative_spaciness_close_ni onlayer master at Transform(xpos=0.9, xanchor=0.5)
with charachange
...
show rin negative_spaciness_close_ni onlayer master
with charachange
...
show rin negative_sad_close_ni onlayer master at Slide(0.9,0.5,0.7,0.5,1.0)
with None

show rin relaxed_doubt_close_ni onlayer master at Slide(0.9,0.5,0.7,0.5,1.0)
with Dissolve(1.0)
...
show rin relaxed_surprised_close_ni onlayer master at tworight
with charachange
...
show rin basic_absent_ni onlayer master at tworight
with charachange
...
show rin basic_deadpannormal_ni onlayer master
with charachange
...
scene bg school_gardens onlayer master at Fullpan(8.0)
with locationchange
...
scene bg school_stalls2 onlayer master at Fullpan(8.0, dir="left")
with locationchange
...
show bg school_stalls2 onlayer master at left
...
scene bg school_stalls2 onlayer master
with locationchange
...
show lilly cane_reminisce onlayer master at center
with charaenter
...
show lilly cane_sad onlayer master
with charachange
...
show lilly cane_surprised onlayer master at center
with charaenter
...
show lilly cane_surprised onlayer master at twoleft
show bg school_library onlayer master at bgleft
with charamove
show lilly cane_smile onlayer master at twoleft
...
show lilly cane_pout onlayer master
with charachange
...
scene bg school_stalls1_ni onlayer master
with shorttimeskip
...
scene bg school_gardens2_ni onlayer master
show lilly basic_smileclosed_ni onlayer master at twoleft
show hanako basic_distant_ni onlayer master at tworight
with locationchange
...
scene bg school_gardens2_ni onlayer master
show lilly basic_weaksmile_ni onlayer master at twoleft
show hanako basic_distant_ni onlayer master at tworight
show fireshine onlayer master
with charachange
...
show lilly basic_concerned_close_ni onlayer master
with characlose
...
show lilly basic_smile_close_ni onlayer master
with charachange
...
show lilly basic_smileclosed_close_ni onlayer master
with charachange
...
show lilly behind_cheerful_close_ni onlayer master
with charachange
...
show lilly basic_reminisce onlayer master at center
with charaenter
...
show hanako defarms_worry onlayer master
with charachange
...
show hanako defarms_worry onlayer master at center
with charaenter
...
scene bg school_dormhallway onlayer master at bgright
...
show kenji neutral onlayer master at Slide(0.5,0.5,0.4,0.5,0.5, time_warp=_ease_out_time_warp)
with None
...
scene bg school_stalls2 onlayer master at Fullpan(8.0)
with locationchange
...
scene bg school_stalls1 onlayer master at bgright
with locationchange
...
scene bg misc_sky onlayer master at Fullpan(25.0)
with locationchange
...
play sound sfx_impact
show kenji rage_close onlayer master:
...
show kenji happy_close onlayer master at offscreenleft
with None

show kenji happy_close onlayer master at twoleft
...
scene ev kenji_rooftop onlayer master
with delayblinds
...
scene ev kenji_rooftop_kenji onlayer master
with flash
...
show ev kenji_rooftop_large onlayer master:
    crop (518, 677, 1440, 1080)
    ease 1.0 crop (1843, 468, 1440, 1080)
...
show ev kenji_rooftop_large onlayer master:
    ease 1.0 crop (518, 677, 1440, 1080)
...
show kenji tsun_ni onlayer master at tworight
show bg school_roof_ni onlayer master at bgleft
with charamove
...
show kenji tsun_ni onlayer master at Transform(xpos=0.7, xanchor=0.5, ypos=1.0, yanchor=0.7)
with charachange
...
show kenji tsun_ni onlayer master at center
show bg school_roof_ni onlayer master at center
with charamove
...
show kenji neutral_close_ni onlayer master
with characlose
...
show bg school_roof_ni onlayer master at Slide(0.5,0.5,0.75,0.75,0.5, time_warp=_ease_time_warp)
show kenji neutral_close_ni onlayer master at Slide(0.5,0.5,0.3,0.5,0.5, time_warp=_ease_time_warp)
with None

show kenji neutral_ni onlayer master at Slide(0.5,0.5,0.3,0.5,0.5, time_warp=_ease_time_warp)
show bg school_roof_ni onlayer master at Slide(0.5,0.5,0.75,0.75,0.5, time_warp=_ease_time_warp)
with charadistant

"I take a step backward."

show kenji neutral_ni onlayer master at Slide(0.3,0.5,0.5,0.5,0.5, time_warp=_ease_time_warp)
with None

show kenji neutral_close_ni onlayer master at Slide(0.3,0.5,0.5,0.5,0.5, time_warp=_ease_time_warp)
with characlose

"He takes a step forward."

show kenji happy_close_ni onlayer master
with charachange
...
show bg school_roof_ni onlayer master at Slide(0.75,0.75,1.0,1.0,0.5, time_warp=_ease_time_warp)
show kenji happy_close_ni onlayer master at Slide(0.5,0.5,0.3,0.5,0.5, time_warp=_ease_time_warp)
with None

show kenji happy_ni onlayer master at Slide(0.5,0.5,0.3,0.5,0.5)
show bg school_roof_ni onlayer master at Slide(0.75,0.75,1.0,1.0,0.5, time_warp=_ease_time_warp)
with charadistant

"I take another step backward."

show kenji happy_ni onlayer master at Slide(0.3,0.5,0.5,0.5,0.5, time_warp=_ease_time_warp)
with None

show kenji happy_close_ni onlayer master at Slide(0.3,0.5,0.5,0.5,0.5, time_warp=_ease_time_warp)
with characlose
...
show black behind bg onlayer master
with None

show n_vignette onlayer master:
...
show kenji happy_close_ni onlayer master:
    ...
    linear 8.0 zoom 0.001
show bg school_roof_ni_crop onlayer master:
    xalign 0.5 yalign 0.5
    linear 8.0 zoom 0.001
...
show nightsky rotation onlayer master
with None
