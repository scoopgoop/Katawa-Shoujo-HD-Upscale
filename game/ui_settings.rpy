...
init 1:
    ...
    image ev hisao_class_start = im.Crop("event/hisao_class.jpg", 0, 0, 1440, 1080)
    ...
    image ev hisao_class_end = im.Crop("event/hisao_class.jpg", 1440, 0, 1440, 1080)
    ...
    image ev emi_knockeddown_facepullout:
        ...
        size (1440,1080) crop (1512, 90, 1440, 1080) subpixel True
        easeout 10.0 crop (1512, 90, 1584, 1188)

    image ev emi_knockeddown_largepullout:
        "event/emi_knockeddown.jpg"
        size (1440,1080) crop (72, 54, 1296, 972) subpixel True
        easein 10.0 crop (0, 0, 1440, 1080)

    image ev emi_knockeddown_face = im.Crop("event/emi_knockeddown_large.jpg", 840, 50, 1440, 1080)

    image ev emi_knockeddown_legs:
        size None crop None subpixel True
        "event/emi_knockeddown_large.jpg"
        xpos 4230 ypos 1818 xanchor 4320 yanchor 3240
        ease 8.0 xpos 3420 ypos 1620

    image ev emi_run_face_zoomin:
        "event/emi_run_face.jpg"
        size (1440,1080) crop (0, 0, 1440, 1080) subpixel True
        ease 10.0 crop (72, 54, 1296, 972)
    ...
    image ev rin_eating_zoomout:
        ...
        size (1440,1080) crop (286,0,1152,864) subpixel True
        acdc_warp 10.0 crop (0, 0, 1440, 1080)
    ...
    image ev rin_nap_total_awind_tears = LiveComposite((1440,1080),
                                                       (0,0), "ev rin_nap_total_awind",
                                                       (0,0), "ev rin_nap_total_tears")
    image ev rin_nap_close_awind_tears = LiveComposite((1440,1080),
    ...
    image evfg lilly_trainride_smiles = im.Composite(None,
                                                ...
                                                (608,542), "event/lilly_train/lilly_trainride_smile.png",
                                                (1031,596), "event/lilly_train/lilly_trainride_hanasmile.png")
    ...
    image unlock_ev lilly_wheat_close = im.Crop("event/lilly_wheat_large.jpg", 900,0,1440,1080)
    ...
    image evfg hanako_breakdown_up = im.Composite(None,
                                                  ...
                                                  (1058,128),"event/hanako_breakdown/hanako_breakdown_up.jpg")
    image evfg hanako_breakdown_closed = im.Composite(None,
                                                      (0,0),"event/hanako_breakdown/hanako_breakdown_down.png",
                                                      (1058,128),"event/hanako_breakdown/hanako_breakdown_closed.jpg")
    ...
    image evmg kenji_glasses_frown = im.Composite(None,
                                          ...
                                          (720,342), "event/kenji_glasses/kenji_glasses_frown.png")
    image evmg kenji_glasses_closed = im.Composite(None,
                                          (0,0), "event/kenji_glasses/kenji_glasses_mg.png",
                                          (720,342), "event/kenji_glasses/kenji_glasses_closed.png")
    ...
    image ev shizu_roof_towardsangry = im.Composite(None,
                                            ...
                                            (538,533), "event/shizu_roof/shizu_roof_towardsangry.jpg")
    image ev shizu_roof_towardsnormal = im.Composite(None,
                                            (0,0),  "event/shizu_roof/shizu_roof.jpg",
                                            (538,533), "event/shizu_roof/shizu_roof_towardsnormal.jpg")
    image ev shizu_roof_smile = im.Composite(None,
                                            (0,0),  "event/shizu_roof/shizu_roof.jpg",
                                            (538,533), "event/shizu_roof/shizu_roof_smile.jpg")

    image ev shizu_roof2 = im.Composite(None,
                                            (0,0),  "event/shizu_roof/shizu_roof.jpg",
                                            (1082,567), "event/shizu_roof/shizu_roof_hisao2.jpg")
    ...
    image ev showdown_lilly = im.Crop("event/lilly_shizu_showdown_large.jpg", 504,180,1440,1080)
    image ev showdown_shizu = im.Crop("event/lilly_shizu_showdown_large.jpg", 2520,288,1440,1080)

    image showdown_lilly_slice = im.Crop("event/lilly_shizu_showdown_large.jpg", 792,468,1440,538)
    image showdown_shizu_slice = im.Crop("event/lilly_shizu_showdown_large.jpg", 2448,576,1440,538)


    image ev kenji_rooftop = "event/kenji_rooftop.jpg"
    image ev kenji_rooftop_large = "event/kenji_rooftop_large.jpg"
    image ev kenji_rooftop_kenji = im.Crop("event/kenji_rooftop_large.jpg", 518,677,1440,1080)
    ...
    $ ex_g_images = (("thumb/other_iwanako.jpg", "evul other_iwanako"),
                     ...
                     ("thumb/hisao_mirror.jpg","ev hisao_mirror_1440"),
    ...
    image videowhite = Solid("#e9e9e7")
    image videoblack = Solid("#0d0d0d")
    image darkgrey = Solid("#0D0D0D")
    image bg school_roof_ni_crop = im.Crop("bgs/school_roof_ni.jpg",200,0,1440,1080)
    ...
    image ev emi_bed_full = LiveComposite((1440,1280),
                                        (0,0),"event/emi_bed_normal.jpg",
                                        (0,1080),"event/emi_bed_legs.jpg")
    ...
    image fireworks = LiveComposite((1440,1080),
    ...
    image fireshine = LiveComposite((1440,1080),
    ...
    image hanako_fw = LiveComposite((1440,1080),
    ...
    image rain normal = LiveComposite((1440, 1080),
                             (0,0), rainAnim(),
                             (0,0), rainAnim(my_offset=0.1, zoom=1.2),
                             )


    image rain light = LiveComposite((1440, 1080),
                             (0,0), rainAnim(alpha=0.3),
                             (0,0), rainAnim(my_offset=0.1, zoom=1.2, alpha=0.3),
                             )

    image rain medium = LiveComposite((1440, 1080),
...
init 5:
    image wallodrugs = drugsDisp(11080,1440)
...
init python:
    ...
    letterbox = LiveComposite((1440,1080),
    ...
    renpy.image("snow",LiveComposite((1440,1080),
                                     (0,0),snowbg,
                                     (0,0),snowfg))
    ...
    renpy.image("dandelions thin",LiveComposite((1440,1080),
                                    (0,0),dandeliontbg,
                                    (0,0),dandeliontfg))
    ...
    renpy.image("dandelions dense",LiveComposite((1440,1080),
                                    (0,0),dandeliondbg,
                                    (0,0),dandeliondfg))
    ...
    def main_menu_composer(is_animated):
        ...
        widget_map = [('tc_act4_shizune', (1219, 554), '16_tc4-shizune.png'),
                      ...
                      ('tc_act4_rin', (947, 342), '13_tc4-rin.png'),
                      ('tc_act3_rin', (1062, 417), '12_tc3-rin-rin.png'),
                      ('tc_act3_rin', (1147, 531), '11_tc3-rin-hisao.png'),
                      ('tc_act2_rin', (1132, 724), '10_tc2-rin.png'),
                      ('tc_act4_lilly', (835, 362), '09_tc4-lilly.png'),
                      ('tc_act3_lilly', (952, 502), '08_tc3-lilly.png'),
                      ('tc_act2_lilly', (1048, 675), '07_tc2-lilly.png'),
                      ('tc_act4_hanako', (688, 502), '06_tc4-hanako.png'),
                      ('tc_act4_emi', (675, 666), '05_tc4-emi.png'),
                      ('tc_act3_emi', (772, 815), '04_tc3-emi.png'),
                      ('tc_act2_emi', (833, 896), '03_tc2-emi.png'),
                      ('tc_act3_hanako', (844, 562), '02_tc3-hanako.png'),
                      ('tc_act2_hanako', (887, 684), '01_tc2-hanako.png'),
    ...
    style.say_dialogue.rest_indent = 25
    ...
    style.comment_frame.xminimum = 1440
    ...
    style.gm_nav_frame.yminimum = 551
    style.gm_nav_frame.background = "ui/bg-gm.png"
    style.gm_nav_frame.top_padding = 97
    ...
    style.yesno_frame_vbox.box_spacing = 54

    style.yesno_button_hbox.xalign = 0.5
    style.yesno_button_hbox.spacing = 180
    ...
    style.file_picker_frame.xmaximum = 864
    ...
    style.file_picker_extra_info.line_spacing = 9
    style.file_picker_extra_info.size = 33
    ...
    style.vscrollbar2.ymaximum = 403
    style.vscrollbar2.xmaximum = 200
