...
show bg school_track onlayer master
with locationskip
...
show emi basic_grin_gym onlayer master at Slide(0.7,0.5,0.5,0.5,1.0,_ease_in_time_warp)
with charaenter
...
show emi excited_circle_gym onlayer master
with charachange
...
show emi excited_laugh_gym_close onlayer master
with charachange
...
scene bg school_dormext_half onlayer master
...
hide steam2 onlayer master
show kenji neutral_naked onlayer master
show steam as newsteam behind kenji onlayer master
show steam2 as newsteam2 behind kenji onlayer master
with charachange
...
show kenji tsun_naked onlayer master
with charachange
...
show kenji happy_naked onlayer master
hide newsteam onlayer master
with charachange
...
show lilly cane_concerned onlayer master at left
with charamoveinleft
...
show lilly cane_surprised onlayer master at left
with charachange
...
show shizu behind_blank onlayer master at offscreenright
show misha hips_grin onlayer master at offscreenright
with None
...
show misha hips_grin behind shizu onlayer master
with None
...
"For all she knows, she's talking to Misha, but knowing that she and Shizune are practically inseparable, she might expect Shizune being the one that actually {i}talks.{/i}"
...
show showdown_lilly_slice onlayer master at Transform(xanchor=0.0, xpos=1.0, yalign=0.0)
show showdown_shizu_slice onlayer master at Transform(xanchor=1.0, xpos=0.0, yalign=1.0)
with None

play sound sfx_draw
show showdown_lilly_slice onlayer master at Transform(xalign=0.0, yalign=0.0)
with slice_in

with Pause(0.2)

play sound sfx_draw
show showdown_shizu_slice onlayer master at Transform(xalign=1.0, yalign=1.0)
with slice_in

with Pause(0.2)

play sound sfx_thunder
scene ev showdown onlayer master
with Fade(0.2, 0.0, 3.0, color="#FFF")


play sound sfx_slide2
show ev showdown_large onlayer master:
    size (1440,1080) crop (0, 0, 4320, 3240) subpixel True
    easeout 0.2 crop (504, 180, 1440, 1080)
with None
...
show ev showdown_large onlayer master:
    ease 0.2 crop (2520,288, 1440, 1080)
with None
...
play sound sfx_slide2
show ev showdown_large onlayer master:
    ease 0.2 crop (504, 180, 1440, 1080)
with None
...
scene bg school_scienceroom onlayer master
show lilly cane_listen onlayer master at left
show misha perky_confused onlayer master at center
show shizu basic_angry onlayer master at right
with flash
...
menu:
    ...
    "Don't drag me into this! I've done my part!" if True:


        return m1
    "Hey, come on. Cut me and Lilly some slack!" if True:
...
show lilly cane_displeased onlayer master at center
show bg school_scienceroom onlayer master at bgright
with charamove
...
show misha cross_smile_close onlayer master at offscreenleft
with None

show misha cross_smile_close onlayer master at Transform(xpos=0.1, xanchor=0.5)
...
show misha cross_grin_close onlayer master
with charachange

show misha cross_grin_close onlayer master at twoleft
show bg school_scienceroom onlayer master at bgright
with charamove
...
show shizu behind_smile onlayer master at right
...
show shizu adjust_blush onlayer master at offscreenleft
show misha perky_confused onlayer master at Transform(xanchor=0.5, xpos=-0.45)
show bg school_scienceroom onlayer master at bgleft
with charamove

show hanako emb_timid onlayer master at Transform(xanchor=0.5, xpos=0.93)
with charamoveinright
...
show misha perky_smile onlayer master at Transform(xanchor=0.5, xpos=0.15)
with charamove
...
show shizu basic_angry onlayer master at Transform(xanchor=0.5, xpos=0.35)
with charamove
...
show hanako emb_downsad onlayer master at Transform(xanchor=0.5, xpos=0.97)
with charamove
...
show misha hips_grin onlayer master at Transform(xanchor=0.5, xpos=0.15)
with charachange
...
scene bg school_scienceroom onlayer master at bgleft
show shizu behind_frown onlayer master at Transform(xanchor=0.5, xpos=0.35)
show misha hips_frown onlayer master at Transform(xanchor=0.5, xpos=0.15)
show hanako emb_timid onlayer master at Transform(xanchor=0.5, xpos=0.97)
with None
...
show misha hips_frown onlayer master at twoleft
show bg school_scienceroom onlayer master at bgright
with charamove
...
show misha perky_smile onlayer master at Transform(xalign=-0.15)
with charamove
...
show misha perky_confused_close onlayer master at offscreenleft
show shizu behind_blank onlayer master at twoleft
show bg school_scienceroom onlayer master at bgleft
with ease

hide misha onlayer master
show misha perky_confused_close behind shizu onlayer master at offscreenleft

show shizu basic_normal2 onlayer master at offscreenright
show bg school_scienceroom onlayer master at center
with ease_accel

show shizu cross_angry_close onlayer master at tworight
show bg school_scienceroom onlayer master at bgright
with ease_decel
...
show shizu cross_angry at offscreenright onlayer master with None
show misha cross_frown at offscreenleft onlayer master with None
show shizu cross_angry onlayer master at tworight
show misha cross_frown onlayer master at twoleft
with ease
...
show shizu adjust_happy_ss onlayer master at tworight
show bg school_council_ss onlayer master at bgright
with charamove

show misha perky_smile_ss behind shizu at twoleft onlayer master
with charaenter
...
show misha hips_smile onlayer master at center
with charaenter
...
show misha perky_sad onlayer master at center
show bg school_council_ni onlayer master at center
with charamove
...
show misha perky_confused onlayer master at twoleft
show bg school_council_ni onlayer master at bgleft
with charamove

show shizu basic_normal2 behind misha at tworight onlayer master
with charaenter
...
scene bg mural_unfinished onlayer master
...
show bg school_scienceroom at right onlayer master
show hanako emb_timid onlayer master at right
show shizu behind_frown onlayer master at offscreenleft
show misha hips_frown onlayer master at offscreenleft
with charamove
...
show hanako def_worry onlayer master at right
with charaenter
...
show hanako emb_downsad onlayer master at center
with charaenter
...
show hanako cover_worry_close onlayer master at Transform(xanchor=0.4, xpos=0.0)
with easeinleft
...
scene bg school_room32 onlayer master at bgright
with locationchange
...
show bg school_room32 onlayer master at center
with charamove
...
show kenji tsun onlayer master at Transform(yanchor=0.45, ypos=1.0, xalign=0.5)
with charaenter
...
show hanako cover_distant onlayer master at tworight
with charaenter
...
scene bg school_room32 onlayer master at bgleft
show kenji neutral_close onlayer master at left
show hanako basic_distant_close onlayer master at right
with locationskip
...
show hanako basic_normal_close onlayer master at offscreenright
with charamove
...
show kenji neutral_close onlayer master at left
show hanako basic_normal_close onlayer master at right
with shorttimeskip
...
show hanako basic_smile onlayer master at tworight
...
show hanako basic_normal onlayer master at center
show lilly basic_surprised onlayer master at left
show bg school_room32 onlayer master at bgleft
with charamove

show kenji neutral onlayer master at Transform(xalign=1.15)
with charaenter
...
show lilly cane_smile_ni onlayer master at twoleft
show hanako basic_normal_ni onlayer master at tworight
with charaenter
...
show lilly cane_displeased_ni onlayer master
with charachange
...
show hanako basic_distant_ni onlayer master
with charaenter
...
show lilly cane_giggle_ni onlayer master
show hanako emb_emb_ni onlayer master
with charachange
...
scene bg school_dormext_half_ni onlayer master
show lilly cane_smile_ni onlayer master at twoleft
show hanako basic_smile_ni onlayer master at tworight
with locationskip
